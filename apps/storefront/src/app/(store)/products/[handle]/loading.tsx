  ...
  return (
    <div className="mx-auto max-w-container px-5 py-8 lg:px-8 lg:py-14">
      ...
      <div className="mb-8 flex items-center gap-2">
        <div className="h-3 w-10 animate-pulse rounded bg-brand-100" />
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:gap-20">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-4 gap-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="aspect-square animate-pulse bg-brand-100" />
            ))}
          </div>
        </div>
        ...
        <div className="lg:pt-8">
          ...
          <div className="mt-3 h-6 w-1/4 animate-pulse rounded bg-brand-100" />
          <div className="mt-4 h-4 w-full animate-pulse rounded bg-brand-50" />
          <div className="mt-2 h-4 w-2/3 animate-pulse rounded bg-brand-50" />
          <div className="mt-8 flex gap-2">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="h-10 w-12 animate-pulse bg-brand-100" />
            ))}
          </div>
          <div className="mt-8 h-14 w-full animate-pulse bg-brand-100" />
          <div className="mt-10 space-y-3 border-t border-brand-100 pt-6">
