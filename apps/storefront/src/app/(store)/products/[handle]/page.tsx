  ...
  return (
    <div className="mx-auto max-w-container px-5 py-8 lg:px-8 lg:py-14">
      ...
      <div className="mb-8 flex items-center justify-between">
        <nav className="flex items-center gap-2 text-[11px] uppercase tracking-widest text-ink-500">
          ...
          <span>/</span>
          <span className="text-ink-950">{product.title}</span>
        </nav>
        <Link
          href="/products"
          className="hidden items-center gap-1.5 text-[11px] uppercase tracking-widest text-ink-500 transition-colors hover:text-ink-950 lg:flex"
        >
